...
const std::vector<Professor *> Instancia::instanciar_professor(const std::string &ano_instancia)
{
    ...
    std::ifstream file{"/home/rafflezs/TCC-Heuristica/data/csv/" + ano_instancia + "/Professores.csv"}; // WSL
...
const std::vector<Curso *> Instancia::instanciar_curso(const std::string &ano_instancia)
{
    ...
    std::ifstream file{"/home/rafflezs/TCC-Heuristica/data/csv/" + ano_instancia + "/Cursos.csv"}; // WSL
...
const std::vector<Turma *> Instancia::instanciar_turma(const std::string &ano_instancia)
{
    ...
    std::ifstream file{"/home/rafflezs/TCC-Heuristica/data/csv/" + ano_instancia + "/Turmas.csv"}; // WSL
...
const std::vector<Disciplina *> Instancia::instanciar_disciplina(const std::string &ano_instancia)
{
    ...
    std::ifstream file{"/home/rafflezs/TCC-Heuristica/data/csv/" + ano_instancia + "/Disciplinas.csv"}; // WSL
